...
namespace ECustoms
{
    public partial class frmVehicleSelect : Form
    {
        ...
        public frmVehicleSelect(long declarationID)
        {
            InitializeComponent();
        ...
        private void AddVehicle()
        {
            try
            {
                if (grdVehicle.SelectedRows.Count == 1)
                {
                    ...
                    try
                    {
                        List<viewDeclarationVehicle> listExistedDeclarationVehicleImported = VehicleFactory.GetExistDeclarationVehicleExported(vehicleInfo.VehicleID);
        ...
        {
          this.Text = "Them tu phuong tien da xuat canh" + ConstantInfo.MESSAGE_TITLE + GlobalInfo.CompanyName;
