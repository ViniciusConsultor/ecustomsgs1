...
namespace ECustoms
{
    public partial class FrmAddCheck : SubFormBase
    {
        ...
        private void InitData()
        {
            ...
            if (_mode.Equals(0))
            {  // Add mode
                this.Text = "The moi de nghi kiem tra" + ConstantInfo.MESSAGE_TITLE + GlobalInfo.CompanyName;
            ...
            {
                this.Text = "Cap nhat thong tin de nghi kiem tra" + ConstantInfo.MESSAGE_TITLE + GlobalInfo.CompanyName;
