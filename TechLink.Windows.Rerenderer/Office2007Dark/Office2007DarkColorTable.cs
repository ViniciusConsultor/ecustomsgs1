...
namespace TechLink.Windows.Office2007DarkRenderer
{
    ...
    /// </summary>
    public class Office2007DarkColorTable : ProfessionalColorTable
    {
        #region Static Fixed Colors - Blue Color Scheme
        private static Color _contextMenuTextEnabled = Color.FromArgb(0, 0, 0);
        private static Color _contextMenuTextDisabled = Color.FromArgb(103, 103, 103);
        private static Color _contextMenuBackground = Color.FromArgb(208, 208, 208);
        private static Color _contextMenuOutsideColor = Color.FromArgb(67, 67, 67); //The border of menu hover

        private static Color _contextMenuBack = Color.FromArgb(208, 208, 208);
        
        private static Color _buttonPressedBegin = Color.FromArgb(122, 122, 123);
        private static Color _buttonPressedEnd = Color.FromArgb(122, 122, 123);
        private static Color _buttonPressedMiddle = Color.FromArgb(122, 122, 123);
        
        private static Color _buttonSelectedBegin = Color.FromArgb(122, 122, 123);
        private static Color _buttonSelectedEnd = Color.FromArgb(122, 122, 123);
        private static Color _buttonSelectedMiddle = Color.FromArgb(122, 122, 123);

        private static Color _menuItemSelectedBegin = Color.FromArgb(122, 122, 123);
        private static Color _menuItemSelectedEnd = Color.FromArgb(122, 122, 123);

        private static Color _checkBack = Color.FromArgb(255, 227, 149);
        private static Color _gripDark = Color.FromArgb(0, 0, 0);
        private static Color _gripLight = Color.FromArgb(122, 122, 123);
        private static Color _imageMargin = Color.FromArgb(108, 108, 108);
        private static Color _menuBorder = Color.FromArgb(51, 51, 52);
        private static Color _overflowBegin = Color.FromArgb(51, 51, 52);
        private static Color _overflowEnd = Color.FromArgb(51, 51, 52);
        private static Color _overflowMiddle = Color.FromArgb(51, 51, 52);

        private static Color _menuToolBackBegin = Color.FromArgb(208, 208, 208);
        private static Color _menuToolBackEnd = Color.FromArgb(208, 208, 208);

        private static Color _separatorDark = Color.FromArgb(69, 69, 69);
        private static Color _separatorLight = Color.FromArgb(154, 154, 154);

        private static Color _statusStripLight = Color.FromArgb(113, 113, 114);
        private static Color _statusStripDark = Color.FromArgb(72, 72, 74);

        private static Color _toolStripBorder = Color.FromArgb(0, 0, 0);
        private static Color _toolStripContentEnd = Color.FromArgb(68, 68, 68);

        private static Color _toolStripBegin = Color.FromArgb(68, 68, 68);
        private static Color _toolStripEnd = Color.FromArgb(110, 110, 110);
        private static Color _toolStripMiddle = Color.FromArgb(88, 88, 88);

        private static Color _buttonBorder = Color.FromArgb(0, 0, 0);
        #endregion
        ...
        /// </summary>
        public Office2007DarkColorTable()
        {
        }
        #endregion
        ...
        public Color MenuItemOutsideColor
        {
            get { return _contextMenuOutsideColor; }
        }

        public Color MenuItemBackground
        {
            get { return _contextMenuBackground; }
        }

        public Color MenuItemTextEnabled
        {
            get { return _contextMenuTextEnabled; }
        }

        public Color MenuItemTextDisabled
        {
            get { return _contextMenuTextDisabled; }
        }
