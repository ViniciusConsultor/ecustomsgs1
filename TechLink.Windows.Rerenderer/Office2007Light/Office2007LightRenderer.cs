...
namespace TechLink.Windows.Office2007LightRenderer
{
    /// <summary>
    /// Draw ToolStrips using the Office 2007 themed appearance.
    /// </summary>
    public class Office2007LightRenderer : ToolStripProfessionalRenderer
    {
        ...
        #region Identity
        static Office2007LightRenderer()
        {
        ...
        /// </summary>
        public Office2007LightRenderer()
            : base(new Office2007LightColorTable())
        {
        }
        #endregion
