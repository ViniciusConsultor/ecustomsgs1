...
namespace ECustoms
{
  public partial class frmListUserToAddInGroup : SubFormBase
  {
    ...
    {
      this.Text = "Cap nhat danh sach nguoi dung cho nhom" + ConstantInfo.MESSAGE_TITLE + GlobalInfo.CompanyName;
