...
namespace ECustoms
{
    public partial class frmVehicleChineseSelect : SubFormBase
    {
        ...
        {
            this.Text = "Tim kiem phuong tien xe Trung Quoc" + ConstantInfo.MESSAGE_TITLE + GlobalInfo.CompanyName;
            // Set focus
            txtPlate.Focus();
            BindData();
        }
