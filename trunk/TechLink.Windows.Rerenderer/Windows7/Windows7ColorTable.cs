...
{
    public class Windows7ColorTable : ProfessionalColorTable
    {
        #region Static Fixed Colors - Blue Color Scheme
        //private static Color _contextMenuBack = Color.FromArgb(250, 250, 250);
        private static Color _contextMenuBack = Color.FromArgb(223, 237, 253);
        ...
        private static Color _imageMargin = Color.FromArgb(240, 240, 240);  //Image bgr panel menu
        //private static Color _menuBorder = Color.FromArgb(134, 134, 134);
        private static Color _menuBorder = Color.FromArgb(84, 84, 84);
        //private static Color _overflowBegin = Color.FromArgb(167, 204, 251);
        private static Color _overflowBegin = Color.FromArgb(195, 195, 195);
        //private static Color _overflowEnd = Color.FromArgb(101, 147, 207);
        private static Color _overflowEnd = Color.FromArgb(195, 195, 195);
        //private static Color _overflowMiddle = Color.FromArgb(167, 204, 251);
        private static Color _overflowMiddle = Color.FromArgb(195, 195, 195);
        //private static Color _menuToolBack = Color.FromArgb(191, 219, 255);
        private static Color _menuToolBack = Color.FromArgb(192, 221, 252); //for toolstrip container
        //private static Color _separatorDark = Color.FromArgb(154, 198, 255);
        private static Color _separatorDark = Color.FromArgb(255, 255, 255); //for toolbar
        //private static Color _separatorLight = Color.FromArgb(255, 255, 255);
        private static Color _separatorLight = Color.FromArgb(51, 153, 255); //for toolbar
        //private static Color _statusStripLight = Color.FromArgb(215, 229, 247);
        private static Color _statusStripLight = Color.FromArgb(192, 221, 252);
        //private static Color _statusStripDark = Color.FromArgb(172, 201, 238);
        private static Color _statusStripDark = Color.FromArgb(51, 153, 255);
        //private static Color _toolStripBorder = Color.FromArgb(111, 157, 217);
        private static Color _toolStripBorder = Color.FromArgb(51, 153, 255); //for toolstrip container
        //private static Color _toolStripContentEnd = Color.FromArgb(164, 195, 235);
        private static Color _toolStripContentEnd = Color.FromArgb(51, 153, 255); //for toolstrip container
        //private static Color _toolStripBegin = Color.FromArgb(227, 239, 255);
        private static Color _toolStripBegin = Color.FromArgb(56, 207, 251); //for toolbar
        //private static Color _toolStripEnd = Color.FromArgb(152, 186, 230);
        private static Color _toolStripEnd = Color.FromArgb(192, 221, 252); //for toolbar
        //private static Color _toolStripMiddle = Color.FromArgb(222, 236, 255);
        private static Color _toolStripMiddle = Color.FromArgb(56, 207, 251); //for toolbar
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the Windows7ColorTable class.
        /// </summary>
