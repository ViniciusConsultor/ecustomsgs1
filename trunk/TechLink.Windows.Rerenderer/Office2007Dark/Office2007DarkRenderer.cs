...
namespace TechLink.Windows.Office2007DarkRenderer
{
    /// <summary>
    /// Draw ToolStrips using the Office 2007 themed appearance.
    /// </summary>
    public class Office2007DarkRenderer : ToolStripProfessionalRenderer
    {
        ...
        private static Color _c1 = new Office2007DarkColorTable().MenuItemTextDisabled; //Color.FromArgb(208, 208, 208); //Text menu disabled
        private static Color _c2 = new Office2007DarkColorTable().MenuItemTextEnabled; //Color.FromArgb(255, 255, 255); //Text Menu
        private static Color _c3 = Color.FromArgb(76, 83, 92);
        private static Color _c4 = new Office2007DarkColorTable().MenuItemBackground; //Color.FromArgb(122, 122, 123); //Menu bgr
        private static Color _c5 = Color.FromArgb(255, 255, 255);
        private static Color _c6 = Color.FromArgb(47, 47, 47);
        private static Color _r1 = Color.FromArgb(176, 176, 176);
        private static Color _r2 = Color.FromArgb(176, 176, 176);
        private static Color _r3 = Color.FromArgb(176, 176, 176);
        private static Color _r4 = Color.FromArgb(176, 176, 176);
        private static Color _r5 = Color.FromArgb(176, 176, 176);
        private static Color _r6 = Color.FromArgb(176, 176, 176);
        private static Color _r7 = Color.FromArgb(176, 176, 176);
        private static Color _r8 = Color.FromArgb(176, 176, 176);
        private static Color _r9 = Color.FromArgb(0, 0, 0);
        private static Color _rA = Color.FromArgb(0, 0, 0);
        private static Color _rB = Color.FromArgb(0, 0, 0);
        private static Color _rC = Color.FromArgb(0, 0, 0);
        private static Color _rD = Color.FromArgb(84, 84, 84);
        private static Color _rE = Color.FromArgb(84, 84, 84);
        private static Color _rF = Color.FromArgb(84, 84, 84);
        private static Color _rG = Color.FromArgb(84, 84, 84);
        private static Color _rH = Color.FromArgb(84, 84, 84);
        private static Color _rI = Color.FromArgb(84, 84, 84);
        private static Color _rJ = Color.FromArgb(84, 84, 84);
        private static Color _rK = Color.FromArgb(84, 84, 84);
        private static Color _rL = Color.FromArgb(0, 0, 0);
        private static Color _rM = Color.FromArgb(0, 0, 0);
        private static Color _rN = Color.FromArgb(0, 0, 0);
        private static Color _rO = Color.FromArgb(0, 0, 0);
        private static Color _rP = Color.FromArgb(0, 0, 0);
        private static Color _rQ = Color.FromArgb(0, 0, 0);
        private static Color _rR = Color.FromArgb(0, 0, 0);
        private static Color _rS = Color.FromArgb(0, 0, 0);
        private static Color _rT = Color.FromArgb(0, 0, 0);
        private static Color _rU = Color.FromArgb(0, 0, 0);
        private static Color _rV = Color.FromArgb(0, 0, 0);
        private static Color _rW = Color.FromArgb(0, 0, 0);
        private static Color _rX = Color.FromArgb(0, 0, 0);
        private static Color _rY = Color.FromArgb(0, 0, 0);
        private static Color _rZ = Color.FromArgb(0, 0, 0);
        ...
        private static Color _textContextMenuItem = Color.FromArgb(0, 0, 0);
        private static Color _arrowDisabled = _c1;
        private static Color _arrowLight = Color.FromArgb(113, 113, 114);
        private static Color _arrowDark = Color.FromArgb(0, 0, 0);
        private static Color _separatorMenuLight = new Office2007DarkColorTable().SeparatorLight; //Color.FromArgb(113, 113, 114);
        private static Color _separatorMenuDark = new Office2007DarkColorTable().MenuItemBackground; //Color.FromArgb(84, 84, 84);
        private static Color _contextMenuBack = _c4;
        private static Color _contextCheckBorder = Color.FromArgb(242, 149, 54);
        private static Color _contextCheckTick = Color.FromArgb(0, 0, 0);
        private static Color _statusStripBorderDark = Color.FromArgb(0, 0, 0);
        private static Color _statusStripBorderLight = Color.FromArgb(113, 113, 114);
        private static Color _gripDark = new Office2007DarkColorTable().SeparatorDark;//Color.FromArgb(0, 0, 0);
        private static Color _gripLight = new Office2007DarkColorTable().SeparatorLight;//_c5;
        private static Color _outsideMenuColor = new Office2007DarkColorTable().MenuItemOutsideColor; //Color.FromArgb(0, 0, 0);
        private static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8,
            _outsideMenuColor, _outsideMenuColor);
        private static GradientItemColors _itemDisabledColors = new GradientItemColors(_c4, _c6,
            _outsideMenuColor, _outsideMenuColor, _c6, _outsideMenuColor, _outsideMenuColor,
            _outsideMenuColor, _outsideMenuColor, _outsideMenuColor);
        ...
        /// </summary>
        public Office2007DarkRenderer()
            : base(new Office2007DarkColorTable())
        {
        }
        #endregion
