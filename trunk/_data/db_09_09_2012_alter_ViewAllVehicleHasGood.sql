...
/****** Object:  View [dbo].[ViewAllVehicleHasGood]    Script Date: 09/09/2012 15:55:08 ******/
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ViewAllVehicleHasGood'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'= 6870
         Alias = 2250
         Table = 1170
         Output = 720
         Append = 1400
