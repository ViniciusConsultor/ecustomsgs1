...
ALTER TABLE dbo.tblVehicleType
DROP COLUMN FeePrice

GO

/****** Object:  View [dbo].[ViewAllVehicleHasGood]    Script Date: 05/06/2012 21:09:12 ******/
...
SELECT     dbo.tblVehicle.VehicleID, dbo.tblVehicle.PlateNumber, dbo.tblVehicle.NumberOfContainer, dbo.tblVehicle.DriverName, dbo.tblVehicle.ImportDate, 
                      ...
                      dbo.tblVehicle.ImportReceiptNumber
