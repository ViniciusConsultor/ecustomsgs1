...
namespace ApplicationUtils.Utils.ZipUtils
{
	/// <summary>
	/// ZipBaseException is the base exception class for the SharpZipLibrary.
	...
	public class ZipBaseException : ApplicationException
	{
		...
		/// <summary>
		/// Initializes a new instance of the ZipBaseException class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the ZipBaseException class with a specified error message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the ZipBaseException class with a specified
