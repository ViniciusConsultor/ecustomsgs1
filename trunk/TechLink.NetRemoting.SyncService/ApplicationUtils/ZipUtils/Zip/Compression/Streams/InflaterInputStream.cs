...
namespace ApplicationUtils.Utils.ZipUtils.Zip.Compression.Streams
{
	/// <summary>
	...
	/// as the <see cref="ApplicationUtilities.Utils.ZipUtils.GZip.GZipInputStream">GZipInputStream</see>.
	///
